const { getAllUsers, getUserById, addNewUser, deleteUserById, editUserById, loginUser } = require('../Model/users.model')
...
const allUser = async (req, res, next) => {
    ...
    rtaAllUser.length ? res.status(200).json(allUser)
        : next()
...
module.exports = { allUser, listOne, register, deleteOne, editOne, login, forgot, reset, saveNewPass }